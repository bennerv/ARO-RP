...
func (m *manager) GetSecret(ctx context.Context, secretName, version string) (azkeyvault.SecretBundle, error) {
	return m.kv.GetSecret(ctx, m.keyvaultURI, secretName, version)
}
