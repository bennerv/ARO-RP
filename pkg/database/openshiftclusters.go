...
func NewOpenShiftClusters(ctx context.Context, isLocalDevelopmentMode bool, dbc cosmosdb.DatabaseClient, secretVersion string) (OpenShiftClusters, error) {
	...
	return NewOpenShiftClustersWithProvidedClient(documentClient, collc, secretVersion), nil
}

func NewOpenShiftClustersWithProvidedClient(client cosmosdb.OpenShiftClusterDocumentClient, collectionClient cosmosdb.CollectionClient, secretVersion string) OpenShiftClusters {
